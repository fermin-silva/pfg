...
public class MiBoxAndWhiskerRenderer extends AbstractCategoryItemRenderer
     ...
     * Default constructor.
     */
    public MiBoxAndWhiskerRenderer() {
    ...
    public void setMedianWidth(double medianWidth) {
    ...
    public void drawItem(Graphics2D g2, CategoryItemRendererState state,
        ...
        if (!(dataset instanceof BoxAndWhiskerCategoryDataset)) {
            throw new IllegalArgumentException(
                    "MiBoxAndWhiskerRenderer.drawItem() : the data should be "
        ...
        ValueAxis rangeAxis, CategoryDataset dataset, int row, int column)
    {
        ...
        double aRadius = medianWidth;                 // average radius
...
//        Number yMax = bawDataset.getMaxRegularValue(row, column);
        Number yMax = bawDataset.getMaxOutlier(row, column);
//        Number yMin = bawDataset.getMinRegularValue(row, column);
        Number yMin = bawDataset.getMinOutlier(row, column);
        ...
        if (this.meanVisible) {
            ...
            if (yMean != null) {
                ...
                {
                    double shapeX = (xx + (state.getBarWidth() / 2.0));
                    double shapeY = yyAverage;

                    Shape shape = ShapeUtilities.createTranslatedShape(ShapeUtilities.createDiamond((float) aRadius), shapeX, shapeY);

//                    Shape shape = new Ellipse2D.Double(shapeX, shapeY, aRadius * 2, aRadius * 2);
        ...
        if (showOutliers && yOutliers != null) {
    ...
    private void drawHighFarOut(double aRadius, Graphics2D g2, double xx,
                                double m) {
        System.out.println("Dibujando high farout en " + m + " con xx en " + xx);
    ...
    private void drawLowFarOut(double aRadius, Graphics2D g2, double xx,
                               double m) {
        System.out.println("Dibujando low farout en " + m + " con xx en " + xx);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MiBoxAndWhiskerRenderer)) {
            return false;
        }
        MiBoxAndWhiskerRenderer that = (MiBoxAndWhiskerRenderer) obj;
